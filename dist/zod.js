...
exports.loginWithNumber = exports.loginWithEmail = exports.createUser = exports.calculatePrice = exports.dropLocation = exports.pickupLocation = exports.distance = exports.propertyType = exports.location = exports.isLiftAvaialble = exports.pickupFloor = exports.extraWorker = exports.vanType = void 0;
...
exports.loginWithEmail = zod_1.z.object({
    email: zod_1.z.string().email(),
});
exports.loginWithNumber = zod_1.z.object({
    phoneNumber: zod_1.z.string()
});
